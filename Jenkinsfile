pipeline {
  ...
  post { 
        always { 
            emailext( attachLog: true, body: "Please visit ${env.BUILD_URL} for further information", subject: "Job '${env.JOB_NAME}' (${env.BUILD_NUMBER})", to: "ha.hoang@xpondigital.com,hoangha1991@gmail.com")
        }
    }
}